...
public class Vista {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(Vista.class.getResource("/icons/Annoying-Hipster@High.png")));
		...
		tabbedPane.addTab("Hipster", new ImageIcon(Vista.class.getResource("/icons/Annoying-Hipster@Low.png")), hipster, null);
		
		JPanel non_hipster = new JPanel();
		tabbedPane.addTab("Non Hipster", new ImageIcon(Vista.class.getResource("/icons/Male-User@Low.png")), non_hipster, null);
